package me.creepinson.entity.render;
        ...
        if (entity.getBlock() != null)
        {
            ...
            if (iblockstate.getRenderType() == EnumBlockRenderType.MODEL)
            {
                ...
                if (iblockstate != world.getBlockState(new BlockPos(entity)) && iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE)
                {
                    ...
                    blockrendererdispatcher.getBlockModelRenderer().renderModel(world, blockrendererdispatcher.getModelForState(iblockstate), iblockstate, blockpos, vertexbuffer, false, MathHelper.getPositionRandom(entity.getPosition()));
                    tessellator.draw();
